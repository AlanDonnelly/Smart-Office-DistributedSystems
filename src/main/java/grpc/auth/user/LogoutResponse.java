...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return grpc.auth.user.authenticateUserImpl.internal_static_user_LogoutResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return grpc.auth.user.authenticateUserImpl.internal_static_user_LogoutResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            grpc.auth.user.LogoutResponse.class, grpc.auth.user.LogoutResponse.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof grpc.auth.user.LogoutResponse)) {
      return super.equals(obj);
    }
    grpc.auth.user.LogoutResponse other = (grpc.auth.user.LogoutResponse) obj;
  ...
  public static grpc.auth.user.LogoutResponse parseFrom(
  ...
  public static grpc.auth.user.LogoutResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static grpc.auth.user.LogoutResponse parseFrom(
  ...
  public static grpc.auth.user.LogoutResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static grpc.auth.user.LogoutResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static grpc.auth.user.LogoutResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(grpc.auth.user.LogoutResponse prototype) {
  ...
  public static final class Builder extends
      ...
      grpc.auth.user.LogoutResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return grpc.auth.user.authenticateUserImpl.internal_static_user_LogoutResponse_descriptor;
    }
    ...
    // Construct using grpc.auth.user.LogoutResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public grpc.auth.user.LogoutResponse getDefaultInstanceForType() {
      return grpc.auth.user.LogoutResponse.getDefaultInstance();
    }

    @java.lang.Override
    public grpc.auth.user.LogoutResponse build() {
      grpc.auth.user.LogoutResponse result = buildPartial();
    ...
    @java.lang.Override
    public grpc.auth.user.LogoutResponse buildPartial() {
      grpc.auth.user.LogoutResponse result = new grpc.auth.user.LogoutResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof grpc.auth.user.LogoutResponse) {
        return mergeFrom((grpc.auth.user.LogoutResponse)other);
      } else {
    ...
    public Builder mergeFrom(grpc.auth.user.LogoutResponse other) {
      if (other == grpc.auth.user.LogoutResponse.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      grpc.auth.user.LogoutResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (grpc.auth.user.LogoutResponse) e.getUnfinishedMessage();
  ...
  private static final grpc.auth.user.LogoutResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new grpc.auth.user.LogoutResponse();
  }

  public static grpc.auth.user.LogoutResponse getDefaultInstance() {
