...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return grpc.auth.user.authenticateUserImpl.internal_static_user_LoginResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return grpc.auth.user.authenticateUserImpl.internal_static_user_LoginResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            grpc.auth.user.LoginResponse.class, grpc.auth.user.LoginResponse.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof grpc.auth.user.LoginResponse)) {
      return super.equals(obj);
    }
    grpc.auth.user.LoginResponse other = (grpc.auth.user.LoginResponse) obj;
  ...
  public static grpc.auth.user.LoginResponse parseFrom(
  ...
  public static grpc.auth.user.LoginResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static grpc.auth.user.LoginResponse parseFrom(
  ...
  public static grpc.auth.user.LoginResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static grpc.auth.user.LoginResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static grpc.auth.user.LoginResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(grpc.auth.user.LoginResponse prototype) {
  ...
  public static final class Builder extends
      ...
      grpc.auth.user.LoginResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return grpc.auth.user.authenticateUserImpl.internal_static_user_LoginResponse_descriptor;
    }
    ...
    // Construct using grpc.auth.user.LoginResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public grpc.auth.user.LoginResponse getDefaultInstanceForType() {
      return grpc.auth.user.LoginResponse.getDefaultInstance();
    }

    @java.lang.Override
    public grpc.auth.user.LoginResponse build() {
      grpc.auth.user.LoginResponse result = buildPartial();
    ...
    @java.lang.Override
    public grpc.auth.user.LoginResponse buildPartial() {
      grpc.auth.user.LoginResponse result = new grpc.auth.user.LoginResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof grpc.auth.user.LoginResponse) {
        return mergeFrom((grpc.auth.user.LoginResponse)other);
      } else {
    ...
    public Builder mergeFrom(grpc.auth.user.LoginResponse other) {
      if (other == grpc.auth.user.LoginResponse.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      grpc.auth.user.LoginResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (grpc.auth.user.LoginResponse) e.getUnfinishedMessage();
  ...
  private static final grpc.auth.user.LoginResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new grpc.auth.user.LoginResponse();
  }

  public static grpc.auth.user.LoginResponse getDefaultInstance() {
